...
var findAllTasks = /*#__PURE__*/function () {
  var _ref = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(req, res) {
    var _req$query, size, page, title, condition, _getPagination, limit, offset, task;
        ...
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return _context2.abrupt("return", res.status(400).send({
              message: 'El contenido puede estar vacio'
            }));

          case 2:
            _context2.prev = 2;
            // console.log(req.body)
            newTasks = new _Task["default"]({
        ...
        switch (_context4.prev = _context4.next) {
          ...
          case 4:
            ...
            return _context4.abrupt("return", res.status(404).json({
              message: "La tarea ".concat(id, " no existe")
            }));
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 3:
            data = _context5.sent;
            res.json({
              message: "".concat(data.title, " La tarea se ha eliminado correctamente")
            });
            _context5.next = 10;
            break;
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 3:
            ...
            res.json({
              message: "".concat(updatetask.title, " La tarea se ha modificado correctamente")
            });
            _context6.next = 10;
            break;
